...
| `/vmui` | victoria-metrics.observability:8428 | SPA; no prefix strip — VM serves `/vmui` natively |
| `/vmui/api` | victoria-metrics.observability:8428 | vmui API calls; `strip-vmui` Middleware strips `/vmui` before forwarding |
